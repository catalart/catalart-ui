...
export class ArtCollectionService {
  ...
  getAllArtCollections(query: Query): Observable<ArtCollectionPreview[]> {
    return this.http.get<ArtCollectionPreview[]>(`${environment.API_URL}/art-collection?${query.toUrlParams()}`);
  }
